...
data class User(
        @JsonProperty("GMCL_ID")
        var id:Int = 0,
        @JsonProperty("GMCL_NATIONALID")
        var nationalID:String = "",
        @JsonProperty("GMCL_USERNAME")
        var username:String? = "",
        @JsonProperty("GMCL_EMAIL")
        var email:String = "",
        @JsonProperty("GMCL_PASSWORD")
        var password:String = "",
        @JsonProperty("GMCL_VERFIED")
        var verified:String = "F",
        @JsonProperty("GMCL_HAS_DEPENDENTS")
        var hasDependents:String = "",
        @JsonProperty("GMCL_CREATE_USER")
        var createUser:String = "SpringBoot Medical Client App",
        @JsonProperty("GMCL_CREATE_DATE")
        var createDate:Date = Date(),
        @JsonProperty("GMCL_UPDATE_USER")
        var updateUser: String? = null,
        @JsonProperty("GMCL_UPDATE_DATE")
...
data class CCHIStatus(
        @JsonProperty("CCHI_STATUS_EN")
        var statusEn:String? = "",
        @JsonProperty("CCHI_STATUS_AR")
        var statusAr:String? = "",
        @JsonProperty("RESULT")
        var note:String? =""
)
...
data class VerificationToken(
        @JsonProperty("GMCV_ID")
        val ID:Int = 0,
        @JsonProperty("GMCV_TOKEN")
        var token:String = "",
        @JsonProperty("GMCV_USERID")
        var userID:String = "",
        @JsonProperty("GMCV_EMAIL_OR_PASSWORD")
        var emailOrPassword:String = "",
        @JsonProperty("GMCV_CREATE_USER")
        var createUser:String = "SpringBoot Medical Client App",
        @JsonProperty("GMCV_CREATE_DT")
        var createDate:Date = Date(),
        @JsonProperty("GMCV_UPDATE_USER")
        var updateUser: String? = null,
        @JsonProperty("GMCV_UPDATE_DT")
        var updateDate: Date?= null
...
data class BenefitCode(
        @JsonProperty("HPSP_PROC_SERIAL")
        val code:Int=0,
        @JsonProperty("HPSP_SUB_CD")
        val subCode:Int =0,
        @JsonProperty("BENEFIT")
        val benefit:Long = 0,
        @JsonProperty("HCLS_APPROVAL_LIMIT")
        val approvalLimit:Long =0,
        @JsonProperty("HCLS_OUT_DEDUCTIBLE")
